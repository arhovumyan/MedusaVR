 ...
 */
export async function trainCharacterEmbedding(req: Request, res: Response) {
  try {
 ...
 */
export async function getCharacterEmbeddingStatus(req: Request, res: Response) {
  try {
    const { id: characterId } = req.params;
    const userId = req.user?.id;
 ...
 */
export async function listCharacterEmbeddings(req: Request, res: Response) {
  try {
    const userId = req.user?.id;
