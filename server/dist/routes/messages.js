...
router.post("/", requireAuth, async (req, res) => {
    try {
        ...
        const { conversationId, content, sender = 'user', characterId, characterName, imageUrl, imagePrompt } = req.body;
        if (!content) {
        ...
        const message = await ConversationService.sendMessage(conversationId, userId, content, sender, {
...
router.get("/:conversationId", requireAuth, async (req, res) => {
    try {
        ...
        const result = await ConversationService.getConversationMessages(conversationId, userId, {
            page: Number(page),
            limit: Number(limit)
        });
        res.json(result);
