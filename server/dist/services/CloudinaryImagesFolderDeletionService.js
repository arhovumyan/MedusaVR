...
export class CloudinaryImagesFolderDeletionService {
     ...
     */
    static async findImagesFoldersInFolder(folderPath) {
        try {
            this.ensureConfigured();
            const imagesFolders = [];
     ...
     */
    static async deleteFile(resource) {
        try {
     ...
     */
    static async deleteImagesFolderByPath(folderPath, testMode = false) {
        try {
     ...
     */
    static async deleteSpecificImagesFolders(folderPaths) {
        try {
     ...
     */
    static async deleteAllImagesFolders() {
        try {
