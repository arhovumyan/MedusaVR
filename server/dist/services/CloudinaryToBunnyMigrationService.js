...
export class CloudinaryToBunnyMigrationService {
     ...
     */
    static async getAllCloudinaryFolders() {
        try {
     ...
     */
    static async getCloudinaryResourcesInFolder(folderPath) {
        try {
            this.ensureConfigured();
            const allResources = [];
     ...
     */
    static async downloadCloudinaryFile(url) {
        try {
     ...
     */
    static async migrateFile(resource) {
        try {
            ...
            // Upload to Bunny
            const uploadResult = await BunnyStorageService.uploadFile(bunnyPath, fileBuffer, contentType);
     ...
     */
    static async testMigrationForFolder(folderName) {
        try {
     ...
     */
    static async migrateFolderCompletely(folderName) {
        try {
     ...
     */
    static async migrateAllFolders(progressCallback) {
        try {
