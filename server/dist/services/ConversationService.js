...
import { Character } from "../db/models/CharacterModel.js";
import { Chat } from "../db/models/ChatsModel.js";
    ...
    static async getOrCreateConversation(userId, characterId) {
        try {
            ...
            if (!conversation) {
                ...
                await Character.findOneAndUpdate({ id: characterId }, { $inc: { chatCount: 1 } });
            }
            return conversation;
        }
        catch (error) {
        ...
        try {
            ...
            for (const chat of oldChats) {
                try {
                    ...
                    const conversation = await this.getOrCreateConversation(chat.userId, chat.characterId);
                    // Migrate messages
