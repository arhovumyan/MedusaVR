export class PromptBuilderService {
     ...
     */
    static buildPrompt(characterData) {
        const promptParts = [];
        const styleKeywords = [];
        ...
        if (personalityTraits.length > 0) {
            ...
            const personalityVisuals = this.mapPersonalityToVisuals(personalityTraits);
     ...
     */
    static mapPersonalityToVisuals(traits) {
        const visualMapping = {
            // Calm cluster
     ...
     */
    static extractVisualKeywords(description) {
        const keywords = [];
     ...
     */
    static buildConsistentPrompt(originalPrompt, originalSeed, newContext = '') {
     ...
     */
    static extractCharacterFeatures(prompt) {
        const features = [];
