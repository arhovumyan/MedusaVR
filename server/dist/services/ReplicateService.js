...
export class ReplicateService {
    ...
    async generateResponse(prompt, characterName, characterPersona) {
        try {
            ...
            for await (const event of this.replicate.stream("meta/meta-llama-3-8b-instruct", {
                input: {
                    prompt: fullPrompt,
                    max_tokens: 512,
                    temperature: 0.7,
    ...
    async testConnection() {
        try {
            ...
            const testResponse = await this.generateResponse("Hello, how are you?", "TestBot", "You are a friendly test character.");
