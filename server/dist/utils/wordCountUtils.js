 ...
 */
export async function updateCharacterWordCount(characterId) {
    try {
        let userWords = 0;
        ...
        await CharacterModel.updateOne({ id: characterId }, { $set: { chatCount: totalWords } });
 ...
 */
export async function updateMultipleCharacterWordCounts(characterIds) {
 ...
 */
export async function updateAllCharacterWordCounts() {
    try {
