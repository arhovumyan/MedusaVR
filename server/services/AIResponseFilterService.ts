...
export class AIResponseFilterService {
  ...
  private static prohibitedResponsePatterns = [
   ...
   */
  static filterAIResponse(response: string, characterName?: string): {
   ...
   */
  private static generateSafeResponse(characterName?: string): string {
    const safeResponses = [
   ...
   */
  static getSystemSafetyPrompt(): string {
...
REMEMBER: These safety measures protect both users and the platform. They are non-negotiable and permanent.`;
   ...
   */
  static checkUserManipulation(userMessage: string): {
