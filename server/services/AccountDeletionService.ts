...
export class AccountDeletionService {
   ...
   */
  static async deleteUserAccount(userId: string, reason: string = 'Account deletion'): Promise<{
    success: boolean;
    message: string;
    deletedData?: {
      user: any;
   ...
   */
  static async deleteMultipleAccounts(userIds: string[], reason: string = 'Batch account deletion'): Promise<{
    success: boolean;
    results: Array<{
      userId: string;
      success: boolean;
   ...
   */
  static async getAccountsForDeletion(): Promise<Array<{
    userId: string;
    username: string;
    reason: string;
  }>> {
   ...
   */
  static async scheduleAccountDeletion(userId: string, reason: string): Promise<boolean> {
    try {
