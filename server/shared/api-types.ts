...
export interface Character {
  ...
  avatar?: string;  // Legacy field from API
  avatarUrl?: string;  // New field for consistency
  creatorId: string;
  creator?: {
    username: string;
    avatarUrl?: string;
  ...
  isPublic: boolean;
  chatCount: number;
  likes?: number; // Optional, as it might not be present in older data or certain contexts
  commentsCount?: number; // Number of comments on this character
  rating: number;
  createdAt: string;
  updatedAt: string;
}
